...
grep -q -F 'cd /opt/gopath/src/bitbucket.org/solidfire/terraform-provider-solidfire' /home/vagrant/.bashrc || cat >>/home/vagrant/.bashrc <<EOF

## After login, change to terraform-provider-solidfire directory
cd /opt/gopath/src/bitbucket.org/solidfire/terraform-provider-solidfire
EOF
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder '.', '/opt/gopath/src/bitbucket.org/solidfire/terraform-provider-solidfire'
